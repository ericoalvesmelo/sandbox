      ...
      <div style={{ maxWidth: 1020, margin: "0 auto", padding: "28px 22px" }}>
        ...
        <div style={{ background: "#fff", border: "0.5px solid #C9D6E3", borderRadius: 18, padding: "32px 28px", marginTop: 20, textAlign: "center", boxShadow: "0 1px 2px rgba(26,58,92,0.08)" }}>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a href="https://calendly.com/ericoa-melo/45-min-meeting" target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "14px 28px", borderRadius: 12, background: "#0070C0", color: "#fff", fontSize: 15, fontWeight: 600, textDecoration: "none", boxShadow: "0 4px 14px rgba(11,142,196,0.3)" }}>
